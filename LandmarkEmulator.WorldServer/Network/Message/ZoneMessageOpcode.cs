namespace LandmarkEmulator.WorldServer.Network.Message
{
    public enum ZoneMessageOpcode : uint
    {
        ...
        PlayerUpdateRemovePlayer    = 0x2600100,
        PlayerUpdateKnockback       = 0x2600200,
        PlayerUpdateUpdateHitpoints = 0x2600300,
        PlayerUpdateSetAnimation    = 0x2600400,
        PlayerUpdateAddNotifications = 0x2600500,
        PlayerUpdateRemoveNotifications = 0x2600600,
        PlayerUpdateNpcRelevance    = 0x2600700,
        PlayerUpdateUpdateScale     = 0x2600800,
        PlayerUpdateUpdateTemporaryAppearance = 0x2600900,
        PlayerUpdateRemoveTemporaryAppearance = 0x2600A00,
        PlayerUpdatePlayCompositeEffect = 0x2600B00,
        PlayerUpdateStopCompositeEffect = 0x2600C00,
        PlayerUpdateSetLookAt       = 0x2600D00,
        PlayerUpdateRenamePlayer    = 0x2600E00,
        PlayerUpdateUpdateCharacterState = 0x2600F00,
