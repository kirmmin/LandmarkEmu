...
namespace LandmarkEmulator.WorldServer.Network
{
    public class WorldSession : GatewaySession
    {
        ...
        {
            // sendSelfPacket = Convert.FromHexString(File.ReadAllText("SendSelf.bin").Replace("-", ""));
            // TerrainManifest = Convert.FromHexString(File.ReadAllText("TerrainCellManifest.bin").Replace("-", ""));
        }
        ...
        public override void OnCharacterLogin(CharacterModel model)
        {
            ...
            PackTunnelPacket(sendSelfPacket);
        }
